...
* Modular Design: * GameCoordinator: Manages game states, levels, and final outcomes.
    * Card: Handles individual card data and comparison logic (`rock` > scissors, etc.).
    * ScoreTracker: Decouples the win-condition logic from the player data.
    * Timer: Manages real-time calculations using DateTime.
...
3.  The Duel: The computer will announce its move like "Computer choose: Rock".
4.  Recall: Type the number of the card that beats the computer (e.g., 1 2 3).
5.  Win: Reach the required points for your level to be declared the champion!
